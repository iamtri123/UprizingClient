...
{
    public static final String[][] field_150132_N = {{"leaves_acacia", "leaves_big_oak"}, {"leaves_acacia_opaque", "leaves_big_oak_opaque"}};
    public static final String[] field_150133_O = {"acacia", "big_oak"};
