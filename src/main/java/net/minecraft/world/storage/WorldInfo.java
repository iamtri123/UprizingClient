...
public class WorldInfo {
     ...
     */
    @Getter @Setter private long worldTime;
    ...
    private final WorldTimeSetting setting = Uprizing.getInstance().getSetting(Settings.WORLD_TIME);
    ...
    public long getCustomWorldTime() {
        if (setting.isNotVanilla()) {
            return setting.getAsLong();
        }
