...
@Deprecated
public abstract class GuiUprizing { // GuiSlot - TODO: Optimize
    ...
    @Getter protected final int slotHeight;
    ...
    public GuiUprizing(Minecraft par1Minecraft, int par2, int par3, int par4, int par5, int par6) {
