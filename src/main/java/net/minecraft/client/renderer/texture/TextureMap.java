...
public class TextureMap extends AbstractTexture implements ITickableTextureObject, IIconRegister
{
    ...
    public void loadTextureAtlas(IResourceManager par1ResourceManager)
    {
                    ...
                    if (var26 != null)
                    {
                        ...
                        while (var182.hasNext())
                        {
                            ...
                            if (var30 > 0 && var30 < debugImage.length - 1 && debugImage[var30] == null)
                            {
                                ...
                                {
                                    logger.error("Unable to load miplevel {} from: {}", Integer.valueOf(var30), var32, var20);
                                }
                            }
                        }
                    }
        ...
        {
            logger.info("{}: dropping miplevel from {} to {}, because of minTexel: {}", this.basePath, Integer.valueOf(this.field_147636_j), Integer.valueOf(var241), Integer.valueOf(var4));
