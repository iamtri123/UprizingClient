...
import uprizing.waypoint.EnumDimension;
import uprizing.UprizingUtils;
import uprizing.Uprizing;
import uprizing.gui.GuiUprizing;
...
public class GuiWaypoint extends GuiScreen { // TODO: Optimize
    ...
    public GuiWaypoint(final Uprizing uprizing) {
        this(null, uprizing, uprizing.getWaypoints().createWaypoint("",
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            if (button.id == 2) {
                ...
                if (prevScreen == null) {
                    uprizing.getWaypoints().addWaypoint(waypoint);
                }
    ...
    class List extends GuiUprizing {
