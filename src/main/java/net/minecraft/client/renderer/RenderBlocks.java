...
public class RenderBlocks
{
    ...
    {
        if (par1Block.isGlassCube() && !minecraftRB.uprizing.getBoolean(Settings.GLASS_RENDERING)) return false;
    ...
    {
        int var5 = CustomColorizer.getColorMultiplier(blockType, this.blockAccess, blockX, blockY, blockZ);
