...
public class NetHandlerLoginServer implements INetHandlerLoginServer
{
    ...
    public void func_147326_c()
    {
        ...
        String var1 = this.server.getConfigurationManager().allowUserToConnect(this.networkManager.getSocketAddress(), this.loginGameProfile);
        ...
        else
        {
            ...
            this.networkManager.scheduleOutboundPacket(new S02PacketLoginSuccess(this.loginGameProfile));
    ...
    {
        return this.loginGameProfile != null ? this.loginGameProfile + " (" + this.networkManager.getSocketAddress() + ")" : String.valueOf(this.networkManager.getSocketAddress());
    }
    ...
    {
        Validate.validState(this.currentLoginState == NetHandlerLoginServer.LoginState.ACCEPTED || this.currentLoginState == NetHandlerLoginServer.LoginState.HELLO, "Unexpected change in protocol");
        Validate.validState(newState == EnumConnectionState.PLAY || newState == EnumConnectionState.LOGIN, "Unexpected protocol " + newState);
    }
    ...
    public void processLoginStart(C00PacketLoginStart packetIn)
    {
        ...
        if (this.server.isServerInOnlineMode() && !this.networkManager.isLocalChannel())
        {
            ...
            this.networkManager.scheduleOutboundPacket(new S01PacketEncryptionRequest(this.serverId, this.server.getKeyPair().getPublic(), this.field_147330_e));
        }
        else
        {
